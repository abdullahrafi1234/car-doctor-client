    ...
    return (
        <div className="carousel w-full h-[600px] mt-8">
            <div id="slide1" className="carousel-item relative w-full">
                ...
                <div className="absolute h-full gap-5 flex items-center transform  left-0 top-0  bottom-0 bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0)] items-center rounded-xl">
